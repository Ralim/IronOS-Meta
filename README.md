...
Download the zip for Pinecil or Miniware and then install using the instructions in the Flashing section [below](/IronOS-Meta/blob/main/README.md#flashing-the-logo).
